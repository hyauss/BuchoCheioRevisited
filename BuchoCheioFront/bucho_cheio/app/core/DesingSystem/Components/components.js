...
class CustomHeader extends HTMLElement {
    connectedCallback() {
        ...
        <header>
            ...
            <button class="text headerText mobileOption ${active === 'restaurantes' ? 'active' : ''}" aria-label="Resturantes" onclick="window.location.href='../restaurantes/restaurantes.html'">Resturante</button>
